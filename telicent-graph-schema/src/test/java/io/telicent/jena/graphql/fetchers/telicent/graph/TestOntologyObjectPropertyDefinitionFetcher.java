...
public class TestOntologyObjectPropertyDefinitionFetcher extends AbstractFetcherTests {

    @Test
    public void testFetchObjectPropertyDefinition() {
        ...
        OntologyObjectPropertyDefinitionFetcher fetcher = new OntologyObjectPropertyDefinitionFetcher();
        ObjectPropertyDefinition definition = fetcher.get(environment);

        Assert.assertNotNull(definition);
        Assert.assertEquals(definition.getPredicate(), objectProperty);
    }

    @Test
    public void testFetchObjectPropertyDefinitionMissing() {
        DatasetGraph dsg = DatasetGraphFactory.create();
    ...
    @Test
    public void testFetchObjectPropertyDefinitionWithGraphScope() {
        DatasetGraph dsg = DatasetGraphFactory.create();
        ...
        OntologyObjectPropertyDefinitionFetcher fetcher = new OntologyObjectPropertyDefinitionFetcher();
        ObjectPropertyDefinition scoped =
                fetcher.get(prepareFetchingEnvironment(dsg, new io.telicent.jena.graphql.schemas.telicent.graph.models.OntologyPlaceholder(
                        graphA), arguments));
        ObjectPropertyDefinition missing =
                fetcher.get(prepareFetchingEnvironment(dsg, new io.telicent.jena.graphql.schemas.telicent.graph.models.OntologyPlaceholder(
                        graphB), arguments));
