...
/**
 * Fetches sub-properties of a datatype property.
 */
public class DatatypePropertySubPropertiesFetcher implements DataFetcher<List<DatatypePropertyDefinition>> {

    /**
     * Creates a new fetcher.
     */
    public DatatypePropertySubPropertiesFetcher() {
    }
    ...
    public List<DatatypePropertyDefinition> get(DataFetchingEnvironment environment) {
        ...
        return Txn.calculateRead(dsg, () -> {
            Stream<Node> stream = dsg.stream(graphNode, Node.ANY, RDFS.subPropertyOf.asNode(), predicate)
                                     .map(Quad::getSubject)
