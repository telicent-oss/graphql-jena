...
/**
 * Fetches the domain class for a datatype property.
 */
public class DatatypePropertyDomainFetcher implements DataFetcher<RdfsClass> {

    /**
     * Creates a new fetcher.
     */
    public DatatypePropertyDomainFetcher() {
    }
