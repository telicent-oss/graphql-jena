...
/**
 * Represents an object property definition.
 */
public class ObjectPropertyDefinition {
    ...
    /**
     * Creates a new object property definition.
     *
     * @param predicate Property node
     * @param prefixes  Prefix map
     */
    public ObjectPropertyDefinition(Node predicate, PrefixMap prefixes) {
        this(predicate, prefixes, Node.ANY);
    }

    /**
     * Creates a new object property definition with a graph scope.
     *
     * @param predicate Property node
     * @param prefixes  Prefix map
     * @param graphNode Graph node scope
     */
    public ObjectPropertyDefinition(Node predicate, PrefixMap prefixes, Node graphNode) {
