...
/**
 * Fetches super-properties of an object property.
 */
public class ObjectPropertySuperPropertiesFetcher implements DataFetcher<List<ObjectPropertyDefinition>> {

    /**
     * Creates a new fetcher.
     */
    public ObjectPropertySuperPropertiesFetcher() {
    }
