...
/**
 * Fetches object property definitions.
 */
public class OntologyObjectPropertyDefinitionsFetcher implements DataFetcher<List<ObjectPropertyDefinition>> {

    /**
     * Creates a new fetcher.
     */
    public OntologyObjectPropertyDefinitionsFetcher() {
    }
    ...
    public List<ObjectPropertyDefinition> get(DataFetchingEnvironment environment) {
        ...
        return Txn.calculateRead(dsg, () -> {
            Stream<Node> stream = OntologySupport.streamObjectProperties(dsg, graphNode)
