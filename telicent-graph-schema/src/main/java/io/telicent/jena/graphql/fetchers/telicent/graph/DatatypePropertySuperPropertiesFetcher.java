...
/**
 * Fetches super-properties of a datatype property.
 */
public class DatatypePropertySuperPropertiesFetcher implements DataFetcher<List<DatatypePropertyDefinition>> {

    /**
     * Creates a new fetcher.
     */
    public DatatypePropertySuperPropertiesFetcher() {
    }
    ...
    public List<DatatypePropertyDefinition> get(DataFetchingEnvironment environment) {
        ...
        return Txn.calculateRead(dsg, () -> {
            Stream<Node> stream = dsg.stream(graphNode, predicate, RDFS.subPropertyOf.asNode(), Node.ANY)
                                     .map(Quad::getObject)
