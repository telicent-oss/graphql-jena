...
/**
 * Fetches datatype property definitions.
 */
public class OntologyDatatypePropertyDefinitionsFetcher implements DataFetcher<List<DatatypePropertyDefinition>> {

    /**
     * Creates a new fetcher.
     */
    public OntologyDatatypePropertyDefinitionsFetcher() {
    }
