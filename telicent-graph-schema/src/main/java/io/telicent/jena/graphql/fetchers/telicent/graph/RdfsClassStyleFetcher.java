...
/**
 * Fetches style metadata for a class.
 */
public class RdfsClassStyleFetcher implements DataFetcher<Style> {

    /**
     * Creates a new fetcher.
     */
    public RdfsClassStyleFetcher() {
    }

    @Override
    public Style get(DataFetchingEnvironment environment) {
        ...
        return Txn.calculateRead(dsg,
                                 () -> OntologySupport.styleFor(dsg, rdfsClass.getGraphNode(), rdfsClass.getNode()));
    }
}
