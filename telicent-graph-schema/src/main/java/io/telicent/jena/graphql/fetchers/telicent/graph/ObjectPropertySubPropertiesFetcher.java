...
/**
 * Fetches sub-properties of an object property.
 */
public class ObjectPropertySubPropertiesFetcher implements DataFetcher<List<ObjectPropertyDefinition>> {

    /**
     * Creates a new fetcher.
     */
    public ObjectPropertySubPropertiesFetcher() {
    }
