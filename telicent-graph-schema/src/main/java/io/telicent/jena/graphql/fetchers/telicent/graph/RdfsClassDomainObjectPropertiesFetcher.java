...
/**
 * Fetches object properties with the class as domain.
 */
public class RdfsClassDomainObjectPropertiesFetcher implements DataFetcher<List<ObjectPropertyDefinition>> {

    /**
     * Creates a new fetcher.
     */
    public RdfsClassDomainObjectPropertiesFetcher() {
    }
